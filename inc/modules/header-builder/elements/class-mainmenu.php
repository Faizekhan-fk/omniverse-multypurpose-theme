...
class Mainmenu extends Element {
	...
	public function map() {
		$this->args = array(
			'type'            => 'mainmenu',
			'title'           => esc_html__( 'Main menu', 'omniverse' ),
			'text'            => esc_html__( 'Main navigation', 'omniverse' ),
			'icon'            => 'dn-i-main-menu',
			'editable'        => true,
			'container'       => false,
			'drg'             => false,
			...
			'params'          => array(
				...
				'full_screen'         => array(
					...
					'hint'        => '<video src="' . OMNIVERSE_TOOLTIP_URL . 'hb_full_screen.mp4" autoplay loop muted></video>',
					'type'        => 'switcher',
					'tab'         => esc_html__( 'General', 'omniverse' ),
					'value'       => false,
					'description' => esc_html__( 'Enable to show your menu in full screen style on burger icon click.', 'omniverse' ),
				),
				'style'               => array(
					'id'          => 'style',
