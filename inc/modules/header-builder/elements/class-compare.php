...
class Compare extends Element {
	...
	public function map() {
		$this->args = array(
			...
			'text'            => esc_html__( 'Compare icon', 'omniverse' ),
			'icon'            => 'dn-i-compare',
			'editable'        => true,
			'container'       => false,
			'edit_on_create'  => true,
			...
			'params'          => array(
				'design'                 => array(
					...
					'description' => esc_html__( 'You can show the icon only or display "Compare" text too.', 'omniverse' ),
				),
				'icon_design'            => array(
					'id'      => 'icon_design',
					...
					'options' => array(
						'1' => array(
							...
							'image' => OMNIVERSE_ASSETS_IMAGES . '/header-builder/compare-icons/first.jpg',
						),
						'2' => array(
							'value' => '2',
							'label' => esc_html__( 'Second', 'omniverse' ),
							'image' => OMNIVERSE_ASSETS_IMAGES . '/header-builder/compare-icons/second.jpg',
						),
						'4' => array(
							'value' => '4',
							'label' => esc_html__( 'Third', 'omniverse' ),
							'image' => OMNIVERSE_ASSETS_IMAGES . '/header-builder/compare-icons/third.jpg',
						),
						'6' => array(
							'value' => '6',
							'label' => esc_html__( 'Fourth', 'omniverse' ),
							'image' => OMNIVERSE_ASSETS_IMAGES . '/header-builder/compare-icons/fourth.jpg',
						),
						'7' => array(
							'value' => '7',
							'label' => esc_html__( 'Fifth', 'omniverse' ),
							'image' => OMNIVERSE_ASSETS_IMAGES . '/header-builder/compare-icons/fifth.jpg',
						),
						'8' => array(
							'value' => '8',
							'label' => esc_html__( 'Sixth', 'omniverse' ),
							'image' => OMNIVERSE_ASSETS_IMAGES . '/header-builder/compare-icons/sixth.jpg',
						),
					),
				),
				'wrap_type'              => array(
					...
					'options'  => array(
						'icon_only'     => array(
							...
							'image' => OMNIVERSE_ASSETS_IMAGES . '/header-builder/bg-wrap-type/compare-wrap-icon.jpg',
						),
						'icon_and_text' => array(
							'value' => 'icon_and_text',
							'label' => esc_html__( 'Icon and text', 'omniverse' ),
							'image' => OMNIVERSE_ASSETS_IMAGES . '/header-builder/bg-wrap-type/compare-wrap-icon-and-text.jpg',
						),
					),
					'requires' => array(
						'design'      => array(
				...
				'hide_product_count'     => array(
					...
					'hint'        => '<video src="' . OMNIVERSE_TOOLTIP_URL . 'hb_compare_hide_product_count.mp4" autoplay loop muted></video>',
					'type'        => 'switcher',
					'tab'         => esc_html__( 'Style', 'omniverse' ),
				...
				'show_dropdown_category' => array(
					...
					'title'       => esc_html__( 'Show dropdown with category', 'omniverse' ),
					'hint'        => '<video src="' . OMNIVERSE_TOOLTIP_URL . 'hb_compare_show_dropdown_category.mp4" autoplay loop muted></video>',
					'type'        => 'switcher',
					'tab'         => esc_html__( 'Style', 'omniverse' ),
					'group'       => esc_html__( 'Extra', 'omniverse' ),
					'description' => esc_html__( 'Following option work only if "Compare by category" is enabled in theme settings.', 'omniverse' ),
					'value'       => false,
				),
			),
		);
