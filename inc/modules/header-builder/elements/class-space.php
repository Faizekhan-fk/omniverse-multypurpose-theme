...
class Space extends Element {
	...
	public function map() {
		$this->args = array(
			'type'            => 'space',
			'title'           => esc_html__( 'Space', 'omniverse' ),
			'text'            => esc_html__( 'Horizontal spacing', 'omniverse' ),
			'icon'            => 'dn-i-spacing',
			'editable'        => true,
			'container'       => false,
			'edit_on_create'  => true,
			...
			'params'          => array(
				'width'     => array(
					'id'          => 'width',
					'title'       => esc_html__( 'Space width', 'omniverse' ),
					'hint'        => '<video src="' . OMNIVERSE_TOOLTIP_URL . 'hb_space_width.mp4" autoplay loop muted></video>',
					'type'        => 'slider',
					...
					'value'       => 10,
					'units'       => 'px',
					'description' => esc_html__( 'Determine the space width.', 'omniverse' ),
				),
				'css_class' => array(
					'id'          => 'css_class',
