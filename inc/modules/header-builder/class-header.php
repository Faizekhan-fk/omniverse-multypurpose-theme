...
class Header {
	...
	public function __construct( $elements, $id, $new = false ) {
		...
		$this->_id       = ( $id ) ? $id : OMNIVERSE_HB_DEFAULT_ID;
	...
	private function load() {
		...
		$name      = ( isset( $data['name'] ) ) ? $data['name'] : OMNIVERSE_HB_DEFAULT_NAME;
	...
	public function set_structure( $structure = false ) {
		if ( ! $structure ) {
			$structure = omniverse_get_config( 'header-builder-structure' );
		}
	...
	private function validate_settings( $settings ) {
		$default_settings = omniverse_get_config( 'header-builder-settings' );
	...
	public function get_header_sceleton() {
		return omniverse_get_config( 'header-sceleton' );
	}
