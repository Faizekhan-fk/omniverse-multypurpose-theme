...
if ( ! function_exists( 'omniverse_shortcode_single_product_add_to_cart' ) ) {
	/**
	 * Single product add to cart shortcode.
	 *
	 * @param array $settings Shortcode attributes.
	 */
	function omniverse_shortcode_single_product_add_to_cart( $settings ) {
		...
		// Form classes.
		$form_classes .= ' wd-reset-' . omniverse_vc_get_control_data( $settings['reset_button_position'], 'desktop' ) . '-lg';
		$form_classes .= ' wd-reset-' . omniverse_vc_get_control_data( $settings['reset_button_position'], 'mobile' ) . '-md';
		$form_classes .= ' wd-label-' . omniverse_vc_get_control_data( $settings['label_position'], 'desktop' ) . '-lg';
		$form_classes .= ' wd-label-' . omniverse_vc_get_control_data( $settings['label_position'], 'mobile' ) . '-md';
