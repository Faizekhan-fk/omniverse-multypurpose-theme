...
use DN\Modules\Frequently_Bought_Together\Frontend;
...
if ( ! function_exists( 'omniverse_shortcode_single_product_fbt_products' ) ) {
	/**
	 * Single product frequently bought together shortcode.
	 *
	 * @param array $settings Shortcode attributes.
	 */
	function omniverse_shortcode_single_product_fbt_products( $settings ) {
