...
if ( ! function_exists( 'omniverse_shortcode_single_product_reviews' ) ) {
	/**
	 * Reviews shortcode.
	 *
	 * @param array $settings Shortcode attributes.
	 */
	function omniverse_shortcode_single_product_reviews( $settings ) {
		...
		$wrapper_classes .= ' wd-layout-' . omniverse_vc_get_control_data( $settings['layout'], 'desktop' );
