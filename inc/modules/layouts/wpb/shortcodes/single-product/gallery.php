...
if ( ! function_exists( 'omniverse_shortcode_single_product_gallery' ) ) {
	/**
	 * Gallery shortcode.
	 *
	 * @param array $settings Shortcode attributes.
	 */
	function omniverse_shortcode_single_product_gallery( $settings ) {
		...
		<div class="wd-single-gallery wd-wpb<?php echo esc_attr( $wrapper_classes ); ?>">
			...
			wc_get_template(
				...
				array(
					...
					'gallery_columns_desktop'             => omniverse_vc_get_control_data( $settings['slides_per_view'], 'desktop' ),
					'gallery_columns_tablet'              => omniverse_vc_get_control_data( $settings['slides_per_view'], 'tablet' ),
					'gallery_columns_mobile'              => omniverse_vc_get_control_data( $settings['slides_per_view'], 'mobile' ),
					...
					'grid_columns'                        => omniverse_vc_get_control_data( $settings['grid_columns'], 'desktop' ),
					'grid_columns_tablet'                 => omniverse_vc_get_control_data( $settings['grid_columns'], 'tablet' ),
					'grid_columns_mobile'                 => omniverse_vc_get_control_data( $settings['grid_columns'], 'mobile' ),
				)
			);
			?>
		</div>
