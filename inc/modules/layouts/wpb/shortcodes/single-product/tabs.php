...
if ( ! function_exists( 'omniverse_shortcode_single_product_tabs' ) ) {
	/**
	 * Single product tabs shortcode.
	 *
	 * @param array $settings Shortcode attributes.
	 */
	function omniverse_shortcode_single_product_tabs( $settings ) {
		...
		foreach ( array( 'desktop', 'tablet', 'mobile' ) as $device ) {
			...
			$value = omniverse_vc_get_control_data( $settings['reviews_columns'], $device );
		...
		$reviews_classes          = ' wd-layout-' . omniverse_vc_get_control_data( $settings['reviews_layout'], 'desktop' );
		$args                     = array();
		...
		if ( 'tabs' === $settings['layout'] ) {
			$title_wrapper_classes = ' text-' . omniverse_vc_get_control_data( $settings['tabs_alignment'], 'desktop' );
			...
			$title_classes     = ' text-' . omniverse_vc_get_control_data( $settings['accordion_alignment'], 'desktop' );
			$title_classes    .= ' wd-opener-pos-' . omniverse_vc_get_control_data( $settings['accordion_opener_alignment'], 'desktop' );
