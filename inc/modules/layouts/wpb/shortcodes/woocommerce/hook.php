...
if ( ! function_exists( 'omniverse_shortcode_woocommerce_hook' ) ) {
	/**
	 * WooCommerce hook shortcode.
	 *
	 * @param array $settings Shortcode attributes.
	 */
	function omniverse_shortcode_woocommerce_hook( $settings ) {
		...
		$settings['hook'] = omniverse_vc_get_control_data( $settings['hook'], 'desktop' );
