...
if ( ! function_exists( 'omniverse_shortcode_shop_archive_per_page' ) ) {
	/**
	 * Products per page shortcode.
	 *
	 * @param array $settings Shortcode attributes.
	 */
	function omniverse_shortcode_shop_archive_per_page( $settings ) {
		...
		<div class="wd-shop-prod-per-page wd-wpb<?php echo esc_attr( $wrapper_classes ); ?>">
			<?php omniverse_products_per_page_select( false, $settings ); ?>
		</div>
		<?php
