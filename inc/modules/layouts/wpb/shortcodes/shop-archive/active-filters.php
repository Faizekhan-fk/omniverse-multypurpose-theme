...
if ( ! function_exists( 'omniverse_shortcode_shop_archive_active_filters' ) ) {
	/**
	 * Active filters shortcode.
	 *
	 * @param array $settings Shortcode attributes.
	 */
	function omniverse_shortcode_shop_archive_active_filters( $settings ) {
		...
		<div class="wd-shop-active-filters wd-wpb<?php echo esc_attr( $wrapper_classes ); ?>">
			<?php omniverse_get_active_filters(); ?>
		</div>
		<?php
