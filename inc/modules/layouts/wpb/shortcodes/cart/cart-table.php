...
if ( ! function_exists( 'omniverse_shortcode_cart_table' ) ) {
	/**
	 * Cart table shortcode.
	 *
	 * @param array $settings Shortcode attributes.
	 */
	function omniverse_shortcode_cart_table( $settings ) {
		...
		if ( omniverse_get_opt( 'update_cart_quantity_change' ) ) {
					...
					<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents">
						<thead>
							<tr>
								...
								<?php if ( omniverse_get_opt( 'show_sku_in_cart' ) ) : ?>
