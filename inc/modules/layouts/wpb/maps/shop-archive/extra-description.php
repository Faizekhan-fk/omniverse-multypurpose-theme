...
if ( ! function_exists( 'omniverse_get_vc_map_archive_extra_description' ) ) {
	/**
	 * Archive description map.
	 */
	function omniverse_get_vc_map_archive_extra_description() {
		return array(
			'base'        => 'omniverse_shop_archive_extra_description',
			'name'        => esc_html__( 'Category extra description', 'omniverse' ),
			'category'    => omniverse_get_tab_title_category_for_wpb( esc_html__( 'Products archive', 'omniverse' ), 'shop_archive' ),
			'description' => esc_html__( 'Shop category extra description', 'omniverse' ),
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/sa-icons/sa-category-extra-description.svg',
			'params'      => array(
				array(
