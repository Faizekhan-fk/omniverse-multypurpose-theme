...
if ( ! function_exists( 'omniverse_get_vc_map_woocommerce_hook' ) ) {
	/**
	 * WooCommerce hook map.
	 */
	function omniverse_get_vc_map_woocommerce_hook() {
		return array(
			'base'        => 'omniverse_woocommerce_hook',
			'name'        => esc_html__( 'WooCommerce Hook', 'omniverse' ),
			'category'    => omniverse_get_tab_title_category_for_wpb( esc_html__( 'WooCommerce', 'omniverse' ) ),
			'description' => esc_html__( 'WooCommerce PHP hook', 'omniverse' ),
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/sp-icons/sp-hook.svg',
			'params'      => array(
				array(
				...
				array(
					'heading'          => esc_html__( 'Hook', 'omniverse' ),
				...
				array(
					'heading'          => esc_html__( 'Clean actions', 'omniverse' ),
