...
if ( ! function_exists( 'omniverse_get_vc_map_woocommerce_breadcrumb' ) ) {
	/**
	 * WooCommerce breadcrumb map.
	 */
	function omniverse_get_vc_map_woocommerce_breadcrumb() {
		...
		return array(
			'base'        => 'omniverse_woocommerce_breadcrumb',
			'name'        => esc_html__( 'WooCommerce breadcrumbs', 'omniverse' ),
			'category'    => omniverse_get_tab_title_category_for_wpb( esc_html__( 'WooCommerce', 'omniverse' ) ),
			'description' => esc_html__( 'WooCommerce current page breadcrumb', 'omniverse' ),
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/sp-icons/sp-breadcrumb.svg',
			'params'      => array(
				array(
					'group'      => esc_html__( 'Style', 'omniverse' ),
				...
				array(
					'heading'          => esc_html__( 'No wrap on mobile devices', 'omniverse' ),
					'group'            => esc_html__( 'Style', 'omniverse' ),
