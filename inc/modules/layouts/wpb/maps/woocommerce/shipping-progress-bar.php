...
if ( ! function_exists( 'omniverse_get_vc_map_shipping_progress_bar' ) ) {
	/**
	 * Shipping progress bar map.
	 */
	function omniverse_get_vc_map_shipping_progress_bar() {
		return array(
			'base'     => 'omniverse_shipping_progress_bar',
			'name'     => esc_html__( 'Shipping progress bars', 'omniverse' ),
			'category' => omniverse_get_tab_title_category_for_wpb( esc_html__( 'WooCommerce', 'omniverse' ) ),
			'icon'     => OMNIVERSE_ASSETS . '/images/vc-icon/wc-icons/wc-shopping-progress-bar.svg',
			'params'   => array(
				array(
