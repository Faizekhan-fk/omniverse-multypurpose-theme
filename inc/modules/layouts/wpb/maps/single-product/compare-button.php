...
if ( ! function_exists( 'omniverse_get_vc_map_single_product_compare_button' ) ) {
	/**
	 * Compare button map.
	 */
	function omniverse_get_vc_map_single_product_compare_button() {
		...
		return array(
			'base'        => 'omniverse_single_product_compare_button',
			'name'        => esc_html__( 'Add to compare button', 'omniverse' ),
			'category'    => omniverse_get_tab_title_category_for_wpb( esc_html__( 'Single product elements', 'omniverse' ), 'single_product' ),
			'description' => esc_html__( 'Add this product to compare', 'omniverse' ),
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/sp-icons/sp-add-to-compare-button.svg',
			'params'      => array(
				array(
