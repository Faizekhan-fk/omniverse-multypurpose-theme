...
if ( ! function_exists( 'omniverse_get_vc_map_single_product_size_guide_button' ) ) {
	/**
	 * Size guide button map.
	 */
	function omniverse_get_vc_map_single_product_size_guide_button() {
		...
		return array(
			'base'        => 'omniverse_single_product_size_guide_button',
			'name'        => esc_html__( 'Size guide button', 'omniverse' ),
			'category'    => omniverse_get_tab_title_category_for_wpb( esc_html__( 'Single product elements', 'omniverse' ), 'single_product' ),
			'description' => esc_html__( 'Size guide popup button', 'omniverse' ),
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/sp-icons/sp-size-guide-button.svg',
			'params'      => array(
				array(
