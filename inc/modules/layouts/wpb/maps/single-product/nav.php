...
if ( ! function_exists( 'omniverse_get_vc_map_single_product_nav' ) ) {
	/**
	 * Navigation map.
	 */
	function omniverse_get_vc_map_single_product_nav() {
		return array(
			'base'        => 'omniverse_single_product_nav',
			'name'        => esc_html__( 'Product navigation', 'omniverse' ),
			'category'    => omniverse_get_tab_title_category_for_wpb( esc_html__( 'Single product elements', 'omniverse' ), 'single_product' ),
			'description' => esc_html__( 'Previous and next products', 'omniverse' ),
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/sp-icons/sp-navigation.svg',
			'params'      => array(
				array(
