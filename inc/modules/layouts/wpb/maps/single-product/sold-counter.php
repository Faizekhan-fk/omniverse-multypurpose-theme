...
if ( ! function_exists( 'omniverse_get_vc_map_single_product_sold_counter' ) ) {
	/**
	 * Sold counter map.
	 */
	function omniverse_get_vc_map_single_product_sold_counter() {
		$sold_counter_typography = omniverse_get_typography_map(
			array(
				'key'      => 'typography',
		...
		return array(
			'base'        => 'omniverse_single_product_sold_counter',
			'name'        => esc_html__( 'Product sold counter', 'omniverse' ),
			...
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/sp-icons/sp-sold-counter.svg',
			'params'      => array(
				array(
