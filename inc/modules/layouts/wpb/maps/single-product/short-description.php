...
if ( ! function_exists( 'omniverse_get_vc_map_single_product_short_description' ) ) {
	/**
	 * Short description map.
	 */
	function omniverse_get_vc_map_single_product_short_description() {
		...
		return array(
			'base'        => 'omniverse_single_product_short_description',
			'name'        => esc_html__( 'Product short description', 'omniverse' ),
			'category'    => omniverse_get_tab_title_category_for_wpb( esc_html__( 'Single product elements', 'omniverse' ), 'single_product' ),
			'description' => esc_html__( 'Short description content', 'omniverse' ),
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/sp-icons/sp-short-description.svg',
			'params'      => array(
				array(
