...
if ( ! function_exists( 'omniverse_get_vc_map_checkout_shipping_details_form' ) ) {
	/**
	 * Shipping details map.
	 */
	function omniverse_get_vc_map_checkout_shipping_details_form() {
		...
		return array(
			'base'        => 'omniverse_checkout_shipping_details_form',
			'name'        => esc_html__( 'Shipping details', 'omniverse' ),
			'category'    => omniverse_get_tab_title_category_for_wpb( esc_html__( 'Checkout', 'omniverse' ), 'checkout_form' ),
			'description' => esc_html__( 'Shipping information fields', 'omniverse' ),
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/ch-icons/ch-shipping-details.svg',
			'params'      => array(
				array(
					'group'      => esc_html__( 'Style', 'omniverse' ),
