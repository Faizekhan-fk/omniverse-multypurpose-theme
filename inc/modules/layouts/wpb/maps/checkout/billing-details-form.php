...
if ( ! function_exists( 'omniverse_get_vc_map_checkout_billing_details_form' ) ) {
	function omniverse_get_vc_map_checkout_billing_details_form() {
		...
		return array(
			'base'        => 'omniverse_checkout_billing_details_form',
			'name'        => esc_html__( 'Billing details', 'omniverse' ),
			'category'    => omniverse_get_tab_title_category_for_wpb( esc_html__( 'Checkout', 'omniverse' ), 'checkout_form' ),
			'description' => esc_html__( 'Billing information fields', 'omniverse' ),
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/ch-icons/ch-billing-details.svg',
			'params'      => array(
				/**
				 * Title.
				 */
