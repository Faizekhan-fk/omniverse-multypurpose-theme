...
if ( ! function_exists( 'omniverse_get_vc_map_checkout_coupon_form' ) ) {
	function omniverse_get_vc_map_checkout_coupon_form() {
		...
		return array(
			'base'        => 'omniverse_checkout_coupon_form',
			'name'        => esc_html__( 'Coupon form', 'omniverse' ),
			'category'    => omniverse_get_tab_title_category_for_wpb( esc_html__( 'Checkout', 'omniverse' ), 'checkout_content' ),
			'description' => esc_html__( 'Apply coupon form', 'omniverse' ),
			'icon'        => OMNIVERSE_ASSETS . '/images/vc-icon/ch-icons/ch-coupon-form.svg',
			'params'      => array(
				array(
