...
class Payment_Methods extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Payment methods', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Payment title', 'omniverse' ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Payment description', 'omniverse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Terms and conditions', 'omniverse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
