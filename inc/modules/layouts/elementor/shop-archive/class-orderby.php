...
class Orderby extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Order by', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'mobile_icon',
			array(
				'label'        => esc_html__( 'Icon on mobile', 'omniverse' ),
				'description'  => esc_html__( 'Show an icon button on mobile devices instead of dropdown.', 'omniverse' ),
