...
class Price_Table extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product dynamic discounts table', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'price_color',
			array(
				'label'     => esc_html__( 'Price color', 'omniverse' ),
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Price typography', 'omniverse' ),
		...
		$this->add_control(
			'discount_color',
			array(
				'label'     => esc_html__( 'Discount color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Discount typography', 'omniverse' ),
