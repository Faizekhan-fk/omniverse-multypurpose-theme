...
class Compare_Button extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Add to compare button', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'text' => array(
						'title' => esc_html__( 'Icon with text', 'omniverse' ),
						'image' => OMNIVERSE_ASSETS_IMAGES . '/settings/icon-style/icon-with-text.jpg',
						'style' => 'col-2',
					),
					'icon' => array(
						'title' => esc_html__( 'Icon only', 'omniverse' ),
						'image' => OMNIVERSE_ASSETS_IMAGES . '/settings/icon-style/only-icon.jpg',
					),
				),
				'default' => 'text',
			)
