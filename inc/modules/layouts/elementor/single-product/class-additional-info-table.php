...
class Additional_Info_Table extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product additional information table', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'include' => array(
						'title' => esc_html__( 'Include', 'omniverse' ),
					),
					'exclude' => array(
						'title' => esc_html__( 'Exclude', 'omniverse' ),
					),
				),
				'default' => 'all',
			)
		...
		$this->add_control(
			'include',
			array(
				'label'       => esc_html__( 'Include', 'omniverse' ),
				'type'        => Controls_Manager::SELECT2,
				'multiple'    => true,
				'default'     => array(),
				'options'     => omniverse_get_products_attributes(),
				'label_block' => true,
				'condition'   => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Attributes', 'omniverse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
	...
	protected function render() {
		...
		if ( 'image' === $settings['icon_type'] && isset( $settings['image']['id'] ) && $settings['image']['id'] ) {
			...
			$icon_output = omniverse_elementor_get_render_icon( $settings['icon'] );
