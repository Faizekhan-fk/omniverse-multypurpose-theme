...
class Stock_Status extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product stock status', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'description'        => esc_html__( 'Useful for variable products where the "Stock status" label appears after selecting a variation.', 'omniverse' ),
	...
	protected function render() {
		Main::setup_preview();
			...
			omniverse_enqueue_js_script( 'stock-status' );
