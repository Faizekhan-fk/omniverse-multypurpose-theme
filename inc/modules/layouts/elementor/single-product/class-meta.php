...
class Meta extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product meta', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'show_sku',
			array(
				'label'        => esc_html__( 'Show SKU', 'omniverse' ),
		...
		$this->add_control(
			'show_categories',
			array(
				'label'        => esc_html__( 'Show categories', 'omniverse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'yes',
				'label_on'     => esc_html__( 'On', 'omniverse' ),
				'label_off'    => esc_html__( 'Off', 'omniverse' ),
		...
		$this->add_control(
			'show_tags',
			array(
				'label'        => esc_html__( 'Show tags', 'omniverse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'yes',
				'label_on'     => esc_html__( 'On', 'omniverse' ),
				'label_off'    => esc_html__( 'Off', 'omniverse' ),
