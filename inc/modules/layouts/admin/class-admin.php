...
class Admin extends Singleton {
	 ...
	 * @var string
	 */
	private $post_type = 'omniverse_layout';
	/**
	 * Type meta key.
	 *
	 * @var string
	...
	public function init() {
		$this->layout_types = array(
			'single_product'   => esc_html__( 'Single product', 'omniverse' ),
			'shop_archive'     => esc_html__( 'Products archive', 'omniverse' ),
			'cart'             => esc_html__( 'Cart', 'omniverse' ),
			'checkout_form'    => esc_html__( 'Checkout form', 'omniverse' ),
			'checkout_content' => esc_html__( 'Checkout top content', 'omniverse' ),
		);
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'wd-layout', OMNIVERSE_THEME_DIR . '/inc/modules/layouts/assets/layouts.js', array( 'jquery' ), OMNIVERSE_VERSION, true );
	...
	public function add_actions() {
		add_filter( 'views_edit-omniverse_layout', array( $this, 'print_interface' ) );
		add_filter( 'parse_query', array( $this, 'filter_layouts_by_type' ) );
		add_action(
			'manage_omniverse_layout_posts_columns',
			array(
				$this,
		...
		add_action(
			'manage_omniverse_layout_posts_custom_column',
			array(
				$this,
	...
	public function add_conditions_box( $post_type, $post ) {
		...
		add_meta_box(
			...
			esc_html__( 'Layout conditions', 'omniverse' ),
			array(
				$this,
	...
	public function get_template( $template_name, $args = array() ) {
		...
		include OMNIVERSE_THEMEROOT . '/inc/modules/layouts/admin/templates/' . $template_name . '.php';
	}
	...
	public function get_predefined_layouts() {
		$layouts = array(
			'shop_archive'     => array(
				'layout-1'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/?opts=product_archive_layout_1',
				),
				'layout-2'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/?opts=product_archive_layout_2',
				),
				'layout-3'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/?opts=product_archive_layout_3',
				),
				'layout-4'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/?opts=product_archive_layout_4',
				),
				'layout-5'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/',
				),
				'layout-6'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/?opts=product_archive_layout_5',
				),
				'layout-7'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/?opts=product_archive_layout_6',
				),
				// Megamarket.
				'layout-8'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'megamarket/all-products/',
				),
				'layout-9'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'megamarket/product-category/flooring/',
				),
				'layout-10' => array(
					'url' => OMNIVERSE_DEMO_URL . 'megamarket/product-category/tools/',
				),
				// Accessories.
				'layout-11' => array(
					'url' => OMNIVERSE_DEMO_URL . 'accessories/product-category/cases/',
				),
				'layout-12' => array(
					'url' => OMNIVERSE_DEMO_URL . 'accessories/shop/?filter_brand=anker',
				),
				'layout-13' => array(
					'url' => OMNIVERSE_DEMO_URL . 'accessories/shop/',
				),
				// Mega-electronics.
				'layout-14' => array(
					'url' => OMNIVERSE_DEMO_URL . 'mega-electronics/product-category/hardware-components/',
				),
			),
			'single_product'   => array(
				'layout-1'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/lighting/bolla-gervasoni/?opts=single_product_layout_5',
				),
				'layout-2'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/furniture/vivant-janus-charles/?opts=single_product_layout_1',
				),
				'layout-3'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/furniture/sculptures-jeux/?opts=single_product_layout_2',
				),
				'layout-4'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/furniture/slat-bench/?opts=single_product_layout_3',
				),
				'layout-5'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/furniture/feelgood-designs/?opts=single_product_layout_4',
				),
				'layout-6'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/toys/augue-adipiscing-euismod/',
				),
				'layout-7'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/furniture/reflect-chest-of-drawers/?opt=product_sticky',
				),
				'layout-8'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/furniture/char-with-love/?opt=product_shadow',
				),
				'layout-9'  => array(
					'url' => OMNIVERSE_DEMO_URL . 'shop/furniture/euismod-aliquam-parturient/?opt=accordion_content',
				),
				// Megamarket.
				'layout-10' => array(
					'url' => OMNIVERSE_DEMO_URL . 'megamarket/product/rectangular-sink/',
				),
				// Accessories.
				'layout-11' => array(
					'url' => OMNIVERSE_DEMO_URL . 'accessories/product/iphone-12-pro-moment-case-blue/',
				),
				// Mega-electronics.
				'layout-12' => array(
					'url' => OMNIVERSE_DEMO_URL . 'mega-electronics/product/apple-macbook-pro-16-m1-pro-2/',
				),
			),
			'cart'             => array(
				'layout-1' => array(),
	...
	public function print_tabs() {
		$tabs = array(
			'all' => esc_html__( 'All', 'omniverse' ),
		) + $this->layout_types + array(
			'checkout' => esc_html__( 'Checkout', 'omniverse' ),
		);
