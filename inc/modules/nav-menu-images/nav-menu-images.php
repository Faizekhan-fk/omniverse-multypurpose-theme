...
class Nav_Menu_Images {
	...
	public function init() {
		...
		// Load admin file
		if ( is_admin() ) {
			require_once get_parent_theme_file_path( OMNIVERSE_FRAMEWORK . '/modules/nav-menu-images/inc/admin.php' );
	...
	public function ajax_added_thumbnail() {
		check_ajax_referer( 'omniverse-mega-menu-added-thumbnail-nonce', 'security' );
