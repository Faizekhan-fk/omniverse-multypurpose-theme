 ...
 * ------------------------------------------------------------------------------------------------
 */
if ( ! function_exists( 'omniverse_size_guide_shortcode' ) ) {
	function omniverse_size_guide_shortcode( $element_args ) {
				...
				if ( $terms ) {
					foreach ( $terms as $term ) {
						if ( get_term_meta( $term->term_id, 'omniverse_chosen_sguide', true ) ) {
							$id = get_term_meta( $term->term_id, 'omniverse_chosen_sguide', true );
						}
					}
				}
			}
		...
		$size_tables = get_post_meta( $sguide_post->ID, 'omniverse_sguide', true );
