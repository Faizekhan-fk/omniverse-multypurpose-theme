...
if ( ! function_exists( 'omniverse_shortcode_text_block' ) ) {
	function omniverse_shortcode_text_block( $atts, $content ) {
		...
		omniverse_enqueue_inline_style( 'text-block' );
		...
		return apply_filters( 'vc_shortcode_output', ob_get_clean(), new WD_WPBakeryShortCodeFix(), $atts, 'omniverse_text_block' );
	}
}
