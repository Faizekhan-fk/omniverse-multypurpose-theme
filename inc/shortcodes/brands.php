...
if ( ! function_exists( 'omniverse_shortcode_brands' ) ) {
	function omniverse_shortcode_brands( $atts, $content = '' ) {
		...
		if ( empty( $attribute ) || ! taxonomy_exists( $attribute ) ) {
			return '<div class="wd-notice wd-info">' . esc_html__( 'You must select your brand attribute in Theme Settings -> Shop -> Brands', 'omniverse' ) . '</div>';
		}
