...
if ( ! function_exists( 'omniverse_shortcode_video' ) ) {
	function omniverse_shortcode_video( $settings ) {
		...
		if ( 'overlay' === $settings['video_action_button'] && $settings['video_image_overlay'] ) {
			$image_output = omniverse_otf_get_image_html( $settings['video_image_overlay'], $settings['video_image_overlay_size'] );
		}
		...
		<div class="wd-el-video wd-wpb<?php echo esc_attr( $wrapper_classes ); ?>">
			...
			<?php if ( 'action_button' === $settings['video_action_button'] && $settings['button_text'] ) : ?>
				...
				?>
				<?php echo omniverse_shortcode_button( $settings, true ); ?>
			<?php endif; ?>
