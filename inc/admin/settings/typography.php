...
Options::add_field(
	array(
		...
		'name'         => esc_html__( 'Text font', 'omniverse' ),
		'description'  => esc_html__( 'Set general font for site content. This font will also be applied to other typography options if they are not set.', 'omniverse' ),
		'selector_var' => array(
...
Options::add_field(
	array(
		...
		'type'           => 'typography',
		'section'        => 'typography_section',
		'name'           => esc_html__( 'Title font', 'omniverse' ),
		'description'    => esc_html__( 'Set typography for titles (h1, h2, h3, h4, h5, h6).', 'omniverse' ),
		'selector_var'   => array(
...
Options::add_field(
	array(
		...
		'type'           => 'typography',
		'section'        => 'typography_section',
		'name'           => esc_html__( 'Entities names font', 'omniverse' ),
		'description'    => esc_html__( 'Set titles for posts, products, categories and projects.', 'omniverse' ),
		'selector_var'   => array(
...
Options::add_field(
	array(
		...
		'type'         => 'typography',
		'section'      => 'typography_section',
		'name'         => esc_html__( 'Secondary font', 'omniverse' ),
		'description'  => esc_html__( 'Typography for page builder elements options where "Secondary font" was chosen or used custom CSS class "font-alt".', 'omniverse' ),
		'selector_var' => array(
...
Options::add_field(
	array(
		...
		'type'           => 'typography',
		'section'        => 'typography_section',
		'name'           => esc_html__( 'Widget titles font', 'omniverse' ),
		'description'    => esc_html__( 'Typography options for widget titles.', 'omniverse' ),
		'selector_var'   => array(
...
Options::add_field(
	array(
		...
		'type'           => 'typography',
		'section'        => 'typography_section',
		'name'           => esc_html__( 'Header font', 'omniverse' ),
		'description'    => esc_html__( 'Typography options for site header elements.', 'omniverse' ),
		'selector_var'   => array(
...
Options::add_field(
	array(
		...
		'selectors'      => '',
		'callback'       => 'omniverse_get_theme_settings_selectors_array',
		'color-hover'    => true,
		'text-transform' => true,
		'priority'       => 10,
		'class'          => 'dn-hide-field-title',
	)
);
...
Options::add_field(
	array(
		...
		'name'     => '',
		'content'  => wp_kses(
			__( 'Here you can change the typography settings for individual site elements regardless of basic settings. For example, change the font size for the price, set the color for mobile menu links, increase post titles font size, change breadcrumbs color, etc. Using “Custom selector” option allows you to write your own CSS selector and apply any font rules to it.', 'omniverse' ),
			array(
				'a'      => array(
					'href'   => true,
					'target' => true,
...
Options::add_field(
	array(
		...
		'name'     => 'Custom fonts',
		'section'  => 'custom_fonts_section',
		'fonts'    => apply_filters( 'omniverse_custom_fonts_type', array( 'woff', 'woff2' ) ),
		'priority' => 20,
		'class'    => 'dn-hide-field-title',
	)
);
...
Options::add_field(
	array(
		...
		'options'  => array(
			'font'   => array(
				'1' => array(
					'name'  => esc_html__( 'Icon font 1', 'omniverse' ),
					'value' => '1',
				),
				'2' => array(
					'name'  => esc_html__( 'Icon font 2', 'omniverse' ),
					'value' => '2',
				),
				'3' => array(
					'name'  => esc_html__( 'Icon font 3', 'omniverse' ),
					'value' => '3',
				),
			),
			'weight' => array(
				...
				'700' => array(
					'name'  => esc_html__( 'Bold', 'omniverse' ),
					'value' => '700',
				),
			),
		),
...
Options::add_field(
	array(
		'id'          => 'typekit_id',
		'name'        => esc_html__( 'Adobe project IDs', 'omniverse' ),
		'description' => esc_html__( 'Enter your ', 'omniverse' ) . '<a target="_blank" href="https://fonts.adobe.com/my_fonts#web_projects-section">Adobe project IDs</a> separate with coma: tpm3one, qny2aiv.',
		'type'        => 'text_input',
		'section'     => 'typekit_section',
		'priority'    => 20,
	)
...
Options::add_field(
	array(
		'id'          => 'typekit_fonts',
		'name'        => esc_html__( 'Adobe font face', 'omniverse' ),
		'description' => esc_html__( 'Example: futura-pt, lato', 'omniverse' ),
		'type'        => 'text_input',
		'section'     => 'typekit_section',
		'priority'    => 30,
	)
