...
Options::add_field(
	array(
		...
		'hint'        => '<video data-src="' . OMNIVERSE_TOOLTIP_URL . 'footer-sticky-footer.mp4" autoplay loop muted></video>',
...
Options::add_field(
	array(
		...
		'hint'        => '<video data-src="' . OMNIVERSE_TOOLTIP_URL . 'footer-collapse-widgets-on-mobile.mp4" autoplay loop muted></video>',
...
Options::add_field(
	array(
		...
		'hint'        => '<video data-src="' . OMNIVERSE_TOOLTIP_URL . 'footer-copyrights.mp4" autoplay loop muted></video>',
...
Options::add_field(
	array(
		...
		'options'     => array(
			'two-columns' => array(
				'name'  => esc_html__( 'Two columns', 'omniverse' ),
				'hint'        => '<video data-src="' . OMNIVERSE_TOOLTIP_URL . 'footer-copyrights-2-column.mp4" autoplay loop muted></video>',
				'value' => 'two-columns',
			),
			'centered'    => array(
				'name'  => esc_html__( 'Centered', 'omniverse' ),
				'hint'        => '<video data-src="' . OMNIVERSE_TOOLTIP_URL . 'footer-copyrights-1-column.mp4" autoplay loop muted></video>',
				'value' => 'centered',
			),
		),
		'default'     => 'two-columns',
