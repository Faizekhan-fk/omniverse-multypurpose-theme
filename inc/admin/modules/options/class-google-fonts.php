...
class Google_Fonts extends Singleton {
	...
	public function init() {
		self::$all_google_fonts = require dirname( __FILE__ ) . '/controls/typography/google-fonts.php';
	...
	public function enqueue_fonts() {
		...
		if ( 'disable' !== omniverse_get_opt( 'google_font_display' ) ) {
			$link .= '&display=' . omniverse_get_opt( 'google_font_display' );
		}

		wp_enqueue_style( 'dn-google-fonts', 'https://fonts.googleapis.com/css?family=' . str_replace( '|', '%7C', $link ), array(), omniverse_get_theme_info( 'Version' ) );
	}
}
