...
class Background extends Field {
	...
	public function render_control() {
		...
		?>
			<div class="dn-bg-source">
				<div class="dn-bg-color">
				...
				<div class="dn-bg-image">
					<div class="dn-upload-preview<?php echo ( isset( $value['url'] ) && ! empty( $value['url'] ) ) ? ' dn-preview-shown' : ''; ?>">
				...
				<div class="dn-upload-btns">
					...
					<button class="dn-btn dn-color-warning dn-remove-upload-btn dn-i-trash<?php echo ( isset( $value['url'] ) && ! empty( $value['url'] ) ) ? ' dn-active' : ''; ?>"><?php esc_html_e( 'Remove', 'omniverse' ); ?></button>
					<input type="hidden" class="dn-upload-input-url" name="<?php echo esc_attr( $this->get_input_name( 'url' ) ); ?>" value="<?php echo esc_attr( $this->get_field_value( 'url' ) ); ?>" />
			...
			<div class="dn-bg-controls dn-row dn-sp-10">
				<div class="dn-col-xl-6 dn-col-12">
					<div class="dn-bg-image-options dn-row dn-sp-10<?php echo empty( $value['url'] ) ? ' dn-hidden' : ''; ?>">
						<div class="dn-col-lg-6 dn-col-12">
							<select class="dn-bg-repeat" data-placeholder="<?php esc_attr_e( 'Background repeat', 'omniverse' ); ?>" name="<?php echo esc_attr( $this->get_input_name( 'repeat' ) ); ?>">
								<option value=""></option>
						...
						<div class="dn-col-lg-6 dn-col-12">
							<select class="dn-bg-size" data-placeholder="<?php esc_attr_e( 'Background size', 'omniverse' ); ?>" name="<?php echo esc_attr( $this->get_input_name( 'size' ) ); ?>">
								<option value=""></option>
						...
						<div class="dn-col-lg-6 dn-col-12">
							<select class="dn-bg-attachment" data-placeholder="<?php esc_attr_e( 'Background attachment', 'omniverse' ); ?>" name="<?php echo esc_attr( $this->get_input_name( 'attachment' ) ); ?>">
								<option value=""></option>
						...
						<div class="dn-col-lg-6 dn-col-12">
							<select class="dn-bg-position" data-placeholder="<?php esc_attr_e( 'Background position', 'omniverse' ); ?>" name="<?php echo esc_attr( $this->get_input_name( 'position' ) ); ?>">
								<option value=""></option>
				...
				<div class="dn-col-xl-6 dn-col-12">
					<div class="dn-bg-preview" style="<?php echo esc_attr( $style ); ?>"></div>
				</div>
			</div>
