...
class XML {
	...
	private function get_file_name() {
		$file_name = 'elementor' === omniverse_get_current_page_builder() ? 'content-elementor.xml' : 'content.xml';

		if ( $this->type !== 'posts' ) {
			$file_name = 'elementor' === omniverse_get_current_page_builder() ? 'content-elementor-' . $this->type . '.xml'
...
//echo "<pre>";print_r($importer);echo "</pre>";
//echo $this->version;exit;
	...
	private function post_meta_replace() {
		$post_meta_key_list = array(
			'_omniverse_title_image',
			'_thumbnail_id',
			'bg_image_desktop',
			'bg_image_tablet',
			'bg_image_mobile',
			'_menu_item_block',
			'omniverse_sguide_select',
