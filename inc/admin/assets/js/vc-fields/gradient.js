(function($) {
	...
	$panel.on('vcPanel.shown', function() {
		$('.wpb_el_type_omniverse_gradient').each( function () {
			var $this = $(this);
			var gradient_line = '#' + $this.find('.omniverse-grad-line').attr('id');
			var gradient_preview = '#' + $this.find('.omniverse-grad-preview').attr('id');
			...
			$this.find('.omniverse-grad-line').gradX(gradient_line, {
