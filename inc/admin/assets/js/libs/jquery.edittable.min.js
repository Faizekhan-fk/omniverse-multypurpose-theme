...
(function ($, window, i) {
    ...
    $.fn.editTable = function (options) {
        ...
        var s = $.extend({
            ...
            defaultth = '<th><a class="addcol dn-bordered-btn dn-color-primary dn-style-icon dn-i-add" title="Add column" href="#"></a> <a class="delcol dn-bordered-btn dn-color-warning dn-style-icon dn-i-trash" title="Remove column" href="#"></a></th>',
            colnumber,
            rownumber,
            reset,
            is_validated = true;
        ...
        function buildRow(data, len) {
            ...
            return $('<tr/>', {
                html: rowcontent + '<td><a class="addrow dn-bordered-btn dn-color-primary dn-style-icon dn-i-add" title="Add row" href="#">+</a> <a class="delrow dn-bordered-btn dn-color-warning dn-style-icon dn-i-trash" title="Remove row" href="#">-</a></td>'
            });
