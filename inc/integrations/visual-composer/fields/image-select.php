...
* Add image select
*/
if( ! function_exists( 'omniverse_add_image_select_type' ) ) {
	function omniverse_add_image_select_type( $settings, $value ) {
		...
		$output = '<div class="wd-select-fields wd-style-images"><ul class="wd-select-buttons omniverse-vc-image-select">';
			$output .= '<input type="hidden" class="omniverse-vc-image-select-input wpb_vc_param_value" name="' . esc_attr( $settings['param_name'] ) . '" value="' . esc_attr( $value ) . '">';
