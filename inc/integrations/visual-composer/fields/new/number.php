...
if ( ! function_exists( 'omniverse_get_number_param' ) ) {
	/**
	 ...
	 * @return false|string
	 */
	function omniverse_get_number_param( $settings, $value ) {
