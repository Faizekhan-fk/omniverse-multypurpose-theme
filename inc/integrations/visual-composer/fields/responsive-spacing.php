...
if ( ! function_exists( 'omniverse_get_responsive_spacing_param' ) ) {
	function omniverse_get_responsive_spacing_param( $settings, $value ) {
		ob_start();
		?>
		<div class="vc_css-editor vc_row vc_ui-flex-row wd-responsive-spacing-wrapper">
			<div class="dn-layout-onion-tabs">
				<span class="wd-desktop dn-active" data-value="desktop">
					<span>Desktop</span>
				</span>
			...
			<?php echo omniverse_get_responsive_spacing_template( 'tablet' ); ?>
			<?php echo omniverse_get_responsive_spacing_template( 'mobile' ); ?>
...
if ( ! function_exists( 'omniverse_get_responsive_spacing_template' ) ) {
	function omniverse_get_responsive_spacing_template( $device ) {
		ob_start();
		?>
