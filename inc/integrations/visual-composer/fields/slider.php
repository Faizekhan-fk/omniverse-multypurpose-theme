...
if ( ! function_exists( 'omniverse_get_slider_param' ) ) {
	/**
	 * Omniverse slider param.
	 *
	 ...
	 * @return string
	 */
	function omniverse_get_slider_param( $settings, $value ) {
		...
		<div class="omniverse-vc-slider">
			...
			<span class="dn-slider-units">
				<span class="wd-slider-unit-control dn-active"><?php echo esc_attr( $settings['units'] ); ?></span>
			</span>
		</div>
		<?php
		return ob_get_clean();
