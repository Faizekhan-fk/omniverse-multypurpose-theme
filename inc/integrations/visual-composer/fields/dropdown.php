...
/**
 * Omniverse dropdown param
 */
if ( ! function_exists( 'omniverse_get_dropdown_param' ) ) {
	function omniverse_get_dropdown_param( $settings, $value ) {
		...
		if ( isset( $settings['callback'] ) && strpos( $settings['callback'], 'html_block' ) && function_exists( 'omniverse_get_html_block_links' ) ) {
			$output .= omniverse_get_html_block_links();
		}
