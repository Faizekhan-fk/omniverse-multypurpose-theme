<?php
/**
 * Omniverse WooCommerce Adjacent Products Class
 *
 * @since    2.4.3
 * @package  dn
 */
...
if ( ! class_exists( 'WC_Adjacent_Products' ) ) :
	/**
	 * The Omniverse WooCommerce Adjacent Products Class
	 */
	class WC_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'omniverse_woocommerce_adjacent_query_args', $args ) );
