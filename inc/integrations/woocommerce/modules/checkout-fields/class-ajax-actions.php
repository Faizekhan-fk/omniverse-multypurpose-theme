...
class Ajax_Actions extends Singleton {
	...
	public function save_fields_order() {
		...
		$field_order    = omniverse_clean( $_POST['sorted_fields'] ); // phpcs:ignore
		$current_tab    = omniverse_clean( $_POST['current_tab'] ); // phpcs:ignore
		...
		update_option( 'zs_checkout_fields_manager_options', $change_options, false );
	}
	...
	public function save_fields_required() {
		...
		$field_name     = omniverse_clean( $_POST['field_name'] ); // phpcs:ignore
	...
	public function save_fields_position() {
		...
		$field_name     = omniverse_clean( $_POST['field_name'] ); // phpcs:ignore
		$position       = omniverse_clean( $_POST['position'] ); // phpcs:ignore
		$current_tab    = omniverse_clean( $_POST['current_tab'] ); // phpcs:ignore
		$default_fields = $this->helper->get_default_fields( $current_tab );
		$change_options = get_option( 'zs_checkout_fields_manager_options', array() );
