...
class Manager extends Singleton {
	...
	public function sort_by_priority( $a, $b ) {
		return $b['omniverse_discount_priority'] <=> $a['omniverse_discount_priority'];
	}
	...
	public function check_discount_condition( $discount_rules, $product ) {
		...
		foreach ( $conditions as $discount_id => $condition ) {
			$conditions[ $discount_id ]['omniverse_discount_priority'] = $this->get_condition_priority( $condition['type'] );
		}
	...
	public function get_condition_priority( $type ) {
		...
		return apply_filters( 'omniverse_dynamic_price_condition_priority', $priority, $type );
	}
	...
	public function get_template( $template_name, $args = array() ) {
		...
		include OMNIVERSE_THEMEROOT . OMNIVERSE_FRAMEWORK . '/integrations/woocommerce/modules/dynamic-discounts/templates/' . $template_name . '.php';
	}
