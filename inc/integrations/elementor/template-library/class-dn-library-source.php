...
/**
 * DN template library source.
 *
 * @since 1.0.0
 */
class ZS_Library_Source extends Source_Base {
	/**
	...
	public function get_title() {
		return esc_html__( 'Zynxsol', 'omniverse' );
	}
	...
	private function get_template_content( $template_id ) {
		$response = wp_remote_get( OMNIVERSE_DEMO_URL . '?omniverse_action=omniverse_get_template&id=' . $template_id );
