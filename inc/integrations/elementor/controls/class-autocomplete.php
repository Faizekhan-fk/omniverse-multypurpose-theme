...
class Autocomplete extends Base_Data_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'dn-autocomplete-control', OMNIVERSE_THEME_DIR . '/inc/integrations/elementor/assets/js/autocomplete.js', [ 'jquery' ], omniverse_get_theme_info( 'Version' ), false );
	}
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				...
				<select id="<?php echo esc_attr( $control_uid ); ?>" class="elementor-select2" type="select2" {{ multiple }} data-setting="{{ data.name }}" data-post-type="{{ data.post_type }}" data-taxonomy="{{ data.taxonomy }}" data-placeholder="<?php echo esc_attr__( 'Search', 'omniverse' ); ?>">
