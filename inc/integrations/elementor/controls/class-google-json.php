...
class Google_Json extends Base_Data_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'dn-google-json-control', OMNIVERSE_THEME_DIR . '/inc/integrations/elementor/assets/js/google-json.js', [ 'jquery' ], omniverse_get_theme_info( 'Version' ), false );
	}
