...
class Elementor extends Singleton {
	...
	function files_include() {
		$files = array(
			'integrations/elementor/template-library/class-dn-library-source',
			'integrations/elementor/template-library/class-dn-library',
		...
		foreach ( $files as $file ) {
			require_once get_parent_theme_file_path( OMNIVERSE_FRAMEWORK . '/' . $file . '.php' );
		}
	}
	...
	public function add_widget_categories( $elements_manager ) {
		$elements_manager->add_category(
			'wd-elements',
			array(
				'title' => esc_html__( '[Zynxsol] Elements', 'omniverse' ),
				'icon'  => 'fab fa-plug',
			)
		);
	}
