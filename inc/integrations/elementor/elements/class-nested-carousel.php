...
class Nested_Carousel extends Widget_Nested_Base {
	...
	public function get_title() {
		return esc_html__( 'Nested carousel', 'omniverse' );
	}
	...
	protected function get_default_children_title() {
		return esc_html__( 'Slide #%d', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'slide_title',
			array(
				'label'       => esc_html__( 'Slide title', 'omniverse' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Slide title', 'omniverse' ),
				'placeholder' => esc_html__( 'Slide title', 'omniverse' ),
				'label_block' => true,
				'dynamic'     => array(
					'active' => true,
				),
		...
		$this->add_control(
			'slides',
			array(
				'label'       => esc_html__( 'Slides', 'omniverse' ),
				'type'        => Control_Nested_Repeater::CONTROL_TYPE,
				'fields'      => $repeater->get_controls(),
				'default'     => array(
					array(
						'slide_title' => esc_html__( 'Slide #1', 'omniverse' ),
					),
					array(
						'slide_title' => esc_html__( 'Slide #2', 'omniverse' ),
					),
					array(
						'slide_title' => esc_html__( 'Slide #3', 'omniverse' ),
					),
				),
	...
	protected function render() {
		$settings                   = wp_parse_args( $this->get_settings_for_display(), omniverse_get_carousel_atts() );
		...
		<div class="wd-nested-carousel wd-carousel-container <?php echo esc_attr( $carousel_container_classes ); ?>">
			<div class="wd-carousel-inner">
				<div class="wd-carousel wd-grid<?php echo esc_attr( $carousel_classes ); ?>" <?php echo omniverse_get_carousel_attributes( $carousel_atts ); // phpcs:ignore ?>>
	...
	protected function content_template() {
		...
		<# if ( settings['slides'] ) {
			...
			const arrowsHoverStyle = '<?php echo esc_attr( omniverse_get_opt( 'carousel_arrows_hover_style', '1' ) ); ?>';
			const arrowsIconType = '<?php echo esc_attr( omniverse_get_opt( 'carousel_arrows_icon_type', '1' ) ); ?>';
			...
			if ( 'undefined' !== typeof settings['carousel_arrows_position'] && settings['carousel_arrows_position'] ) {
				...
				view.addRenderAttribute( carouselArrowsWrapperKey, 'class', 'wd-pos-<?php echo esc_attr( omniverse_get_opt( 'carousel_arrows_position', 'sep' ) ); ?>' );
			}
	...
	private function get_auto_column() {
		...
		foreach ( range( 1, 12 ) as $number ) {
			$auto_column[ $number ] = omniverse_get_col_sizes( $number );
		}
