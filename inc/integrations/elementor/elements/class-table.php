...
class Table extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Table', 'omniverse' );
	}
	...
	protected function register_controls() { // phpcs:ignore
		...
		* /
		...
		$heading_repeater->add_control(
			...
			array(
				'label'   => esc_html__( 'Action', 'omniverse' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'cell',
				'options' => array(
					'row'  => esc_html__( 'Start new row', 'omniverse' ),
					'cell' => esc_html__( 'Add new cell', 'omniverse' ),
				),
			)
		);
		...
		$heading_repeater->add_group_control(
			...
			array(
				...
				'label'          => esc_html__( 'Border', 'omniverse' ),
		...
		$heading_repeater->start_controls_tab(
			...
			array(
				'label'     => esc_html__( 'Settings', 'omniverse' ),
				'condition' => array(
					'heading_content_type' => 'cell',
				),
			)
		...
		$heading_repeater->add_control(
			'heading_cell_span',
			array(
				'label'     => esc_html__( 'Column Span', 'omniverse' ),
				'title'     => esc_html__( 'How many columns should this column span across.', 'omniverse' ),
		...
		$heading_repeater->add_control(
			...
			array(
				'label'     => esc_html__( 'Row Span', 'omniverse' ),
				'title'     => esc_html__( 'How many rows should this column span across.', 'omniverse' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 1,
				'min'       => 1,
				'max'       => 20,
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Body', 'omniverse' ),
			)
		);
		...
		$body_repeater->add_control(
			'body_cell_type',
			array(
				'label'     => esc_html__( 'Cell Type', 'omniverse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'td',
				'options'   => array(
					'td' => esc_html__( 'Default', 'omniverse' ),
					'th' => esc_html__( 'Header', 'omniverse' ),
				),
				'condition' => array(
					'body_content_type' => 'cell',
				),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Table cell padding', 'omniverse' ),
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'body',
				'options' => array(
					'body'       => esc_html__( 'Body', 'omniverse' ),
					'h_even_odd' => esc_html__( 'Horizontal even & odd', 'omniverse' ),
					'v_even_odd' => esc_html__( 'Vertical even & odd', 'omniverse' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Body background color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'body_text_color',
			array(
				'label'     => esc_html__( 'Body text color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Horizontal even background color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Horizontal odd background color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'h_even_text_color',
			array(
				'label'     => esc_html__( 'Horizontal even text color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'h_odd_text_color',
			array(
				'label'     => esc_html__( 'Horizontal odd text color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Vertical even background color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Vertical odd background color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'v_even_text_color',
			array(
				'label'     => esc_html__( 'Vertical even text color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'v_odd_text_color',
			array(
				'label'     => esc_html__( 'Vertical odd text color', 'omniverse' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
	...
	protected function render() {
		...
		omniverse_enqueue_inline_style( 'el-table' );
		?>
