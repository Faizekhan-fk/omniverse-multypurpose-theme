...
class Size_Guide extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Size guide content', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'size_guide_id',
			[
				'label'       => esc_html__( 'Select size guide', 'omniverse' ),
				'type'        => Controls_Manager::SELECT2,
				'label_block' => true,
				'options'     => omniverse_get_size_guides_array( 'elementor' ),
				'default'     => '0',
			]
		);
	...
	protected function render() {
		...
		echo do_shortcode(
			omniverse_size_guide_shortcode(
				array(
