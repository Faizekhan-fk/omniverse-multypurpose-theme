...
class Menu_Anchor extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Navigation anchor', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'offset',
			[
				'label'   => esc_html__( 'Offset (px)', 'omniverse' ),
		...
		$this->add_control(
			'anchor',
			[
				'label'       => esc_html__( 'The ID of Navigation anchor.', 'omniverse' ),
				'type'        => Controls_Manager::TEXT,
				'description' => esc_html__( 'Without #.', 'omniverse' ),
				'default'     => 'anchor1',
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw'             => esc_html__( 'Note: The ID link ONLY accepts these chars: A-Z, a-z, 0-9', 'omniverse' ),
