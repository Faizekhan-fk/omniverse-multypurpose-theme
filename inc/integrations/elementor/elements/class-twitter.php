...
class Twitter extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'X (Twitter)', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'consumer_key',
			[
				'label' => esc_html__( 'Consumer Key', 'omniverse' ),
		...
		$this->add_control(
			'consumer_secret',
			[
				'label' => esc_html__( 'Consumer Secret', 'omniverse' ),
				'type'  => Controls_Manager::TEXT,
			]
		);
		...
		$this->add_control(
			'access_token',
			[
				'label' => esc_html__( 'Access Token', 'omniverse' ),
				'type'  => Controls_Manager::TEXT,
			]
		);
		...
		$this->add_control(
			'accesstoken_secret',
			[
				'label' => esc_html__( 'Access Token Secret', 'omniverse' ),
				'type'  => Controls_Manager::TEXT,
			]
		);
		...
		$this->add_control(
			'name',
			[
				'label'   => esc_html__( 'X Name (without @ symbol)', 'omniverse' ),
				'type'    => Controls_Manager::TEXT,
				'default' => 'x',
			]
		);
		...
		$this->add_control(
			'num_tweets',
			[
				'label'   => esc_html__( 'Number of posts', 'omniverse' ),
		...
		$this->add_control(
			'avatar_size',
			[
				'label'       => esc_html__( 'Size of Avatar', 'omniverse' ),
				'description' => esc_html__( 'Default: 48px', 'omniverse' ),
				'type'        => Controls_Manager::NUMBER,
			]
		);
		...
		$this->add_control(
			'show_avatar',
			[
				'label'        => esc_html__( 'Show your avatar image', 'omniverse' ),
		...
		$this->add_control(
			'exclude_replies',
			[
				'label'        => esc_html__( 'Exclude Replies', 'omniverse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => '0',
				'label_on'     => esc_html__( 'Yes', 'omniverse' ),
				'label_off'    => esc_html__( 'No', 'omniverse' ),
	...
	protected function render() {
		...
		<div class="wd-twitter-element wd-twitter-vc-element">
			<?php omniverse_get_twitts( $settings ); ?>
		</div>
		<?php
	}
}
