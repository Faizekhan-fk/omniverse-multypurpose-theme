...
class Author_Area extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Author area', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'content',
			[
				'label'   => esc_html__( 'Author bio', 'omniverse' ),
				'type'    => Controls_Manager::TEXT,
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			...
			<?php if ( $image_url ) : ?>
				<div class="author-avatar">
					<?php echo apply_filters( 'omniverse_image', '<img src="' . esc_url( $image_url ) . '" class="author-area-image">' ); ?>
				</div>
			<?php endif; ?>
