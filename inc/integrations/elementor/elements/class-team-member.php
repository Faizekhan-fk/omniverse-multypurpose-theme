...
class Team_Member extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Team member', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Social links', 'omniverse' ),
			)
		);
		...
		$this->add_control(
			'skype',
			array(
				'label'   => esc_html__( 'Skype link', 'omniverse' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '#',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Position typography', 'omniverse' ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Social buttons', 'omniverse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
	...
	protected function render() {
		...
		$this->add_render_attribute(
			array(
				...
				'social'   => array(
					'class' => array(
						'wd-social-icons',
						omniverse_get_old_classes( ' omniverse-social-icons' ),
		...
		if ( $settings['omniverse_color_scheme'] ) {
			$this->add_render_attribute( 'wrapper', 'class', 'color-scheme-' . $settings['omniverse_color_scheme'] );
		}
