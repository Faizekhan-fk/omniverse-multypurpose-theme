...
class Counter extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Animated Counter', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'value',
			[
				'label'       => esc_html__( 'Actual value', 'omniverse' ),
				'description' => esc_html__( 'Our final point. For ex.: 95', 'omniverse' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Value typography', 'omniverse' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .omniverse-counter' => 'color: {{VALUE}}',
				],
				'condition' => [
					'color_scheme' => 'custom',
				],
