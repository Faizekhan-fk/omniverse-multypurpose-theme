...
class Menu_Price extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu price', 'omniverse' );
	}
	...
	protected function render() {
		...
		$this->add_render_attribute(
			array(
				'wrapper'     => array(
					'class' => array(
						'wd-menu-price',
						omniverse_get_old_classes( 'omniverse-menu-price' ),
					),
				),
				'price'       => array(
					'class' => array(
		...
		if ( $settings['link'] && $settings['link']['url'] ) {
			...
			$this->add_render_attribute( 'link', 'aria-label', esc_html__( 'Menu price link', 'omniverse' ) );
			...
			<div class="menu-price-desc-wrapp">
				<div class="menu-price-heading">
					...
					<div <?php echo $this->get_render_attribute_string( 'price' ); ?>>
						<?php echo wp_kses( $settings['price'], omniverse_get_allowed_html() ); ?>
					</div>
				</div>
