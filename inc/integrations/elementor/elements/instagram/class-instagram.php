...
class Instagram extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Instagram', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'data_source',
			[
				'label'       => esc_html__( 'Source type', 'omniverse' ),
...
Follow our documentation <a href="https://zynxsol.com/docs/omniverse/faq-guides/setup-instagram-api/" target="_blank">here</a>',
				...
				'options'     => [
					'scrape' => esc_html__( 'Scrape (deprecated)', 'omniverse' ),
					'ajax'   => esc_html__( 'AJAX (deprecated)', 'omniverse' ),
					'api'    => esc_html__( 'API', 'omniverse' ),
					'images' => esc_html__( 'Images', 'omniverse' ),
				],
				'default'     => 'scrape',
			]
		);
		...
		$this->add_control(
			'size',
			[
				'label'       => esc_html__( 'Photo size', 'omniverse' ),
				'description' => esc_html__( 'Enter image size. Example: \'thumbnail\', \'medium\', \'large\', \'full\'. Leave empty to use \'medium\' size.', 'omniverse' ),
		...
		$this->add_control(
			'images_size',
			[
				'label'       => esc_html__( 'Images size', 'omniverse' ),
				'description' => esc_html__( 'Enter image size. Example: \'thumbnail\', \'medium\', \'large\', \'full\'. Leave empty to use \'thumbnail\' size.', 'omniverse' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => 'thumbnail',
			]
		);
		...
		$this->add_control(
			'images_link',
			[
				'label' => esc_html__( 'Images link', 'omniverse' ),
				'type'  => Controls_Manager::TEXT,
			]
		);
		...
		$this->add_control(
			'images_likes',
			[
				'label'       => esc_html__( 'Likes limit', 'omniverse' ),
				'description' => esc_html__( 'Example: 1000-10000', 'omniverse' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '1000-10000',
			]
		);
		...
		$this->add_control(
			'images_comments',
			[
				'label'       => esc_html__( 'Comments limit', 'omniverse' ),
				'description' => esc_html__( 'Example: 0-1000', 'omniverse' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '0-1000',
			]
		);
		...
		$this->add_control(
			'content',
			[
				'label' => esc_html__( 'Instagram text', 'omniverse' ),
		...
		$this->add_control(
			'username',
			[
				'label'   => esc_html__( 'Username', 'omniverse' ),
				'type'    => Controls_Manager::TEXT,
				'default' => 'flickr',
			]
		);
		...
		$this->add_control(
			'target',
			[
				'label'   => esc_html__( 'Open link in', 'omniverse' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'_self'  => esc_html__( 'Current window (_self)', 'omniverse' ),
					'_blank' => esc_html__( 'New window (_blank)', 'omniverse' ),
				],
				'default' => '_self',
			]
		);
		...
		$this->add_responsive_control(
			'per_row',
			[
				'label'      => esc_html__( 'Photos per row', 'omniverse' ),
		...
		$this->add_control(
			'number',
			[
				'label'      => esc_html__( 'Number of photos', 'omniverse' ),
				'type'       => Controls_Manager::SLIDER,
				'default'    => [
					'size' => 9,
				],
		...
		$this->add_control(
			'spacing',
			[
				'label'        => esc_html__( 'Add spaces between photos', 'omniverse' ),
		...
		$this->add_control(
			'hide_mask',
			[
				'label'        => esc_html__( 'Hide likes and comments', 'omniverse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => '0',
				'label_on'     => esc_html__( 'Yes', 'omniverse' ),
				'label_off'    => esc_html__( 'No', 'omniverse' ),
		...
		$this->add_control(
			'rounded',
			array(
				'label'        => esc_html__( 'Rounded corners for images', 'omniverse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => '0',
				'label_on'     => esc_html__( 'Yes', 'omniverse' ),
				'label_off'    => esc_html__( 'No', 'omniverse' ),
	...
	protected function render() {
		omniverse_elementor_instagram_template( $this->get_settings_for_display() );
	}
}
