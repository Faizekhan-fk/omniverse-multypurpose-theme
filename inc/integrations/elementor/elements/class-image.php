...
class Image extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Image or SVG', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'link'     => esc_html__( 'Custom link', 'omniverse' ),
				),
				'default' => 'none',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'description' => esc_html__( 'Enter URL if you want this image to have a link.', 'omniverse' ),
	...
	protected function render() {
		...
		if ( isset( $settings['image']['id'] ) && $settings['image']['id'] ) {
			$icon_output = omniverse_otf_get_image_html(
				$settings['image']['id'],
				$settings['image_size'],
