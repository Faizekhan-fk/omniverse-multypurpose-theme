...
class Video extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Video', 'omniverse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'hosted'  => esc_html__( 'Self hosted', 'omniverse' ),
					'youtube' => esc_html__( 'YouTube', 'omniverse' ),
					'vimeo'   => esc_html__( 'Vimeo', 'omniverse' ),
				),
				'default' => 'hosted',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => esc_html__( 'Enter your URL', 'omniverse' ) . ' (YouTube)',
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Link', 'omniverse' ),
				'type'        => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Enter your URL', 'omniverse' ) . ' (Vimeo)',
		...
		$this->add_control(
			'video_action_button',
			array(
				'label'   => esc_html__( 'Action button', 'omniverse' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'without' => esc_html__( 'Without', 'omniverse' ),
					'overlay' => esc_html__( 'Play button on image', 'omniverse' ),
					'play'    => esc_html__( 'Play button', 'omniverse' ),
					'button'  => esc_html__( 'Button', 'omniverse' ),
				),
				'default' => 'without',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'        => esc_html__( 'Lightbox', 'omniverse' ),
		...
		$this->add_control(
			'video_options',
			array(
				'label'     => esc_html__( 'Video Options', 'omniverse' ),
		...
		$this->add_control(
			'video_autoplay',
			array(
				'label'        => esc_html__( 'Autoplay', 'omniverse' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'no',
				'condition'    => array(
		...
		$this->add_control(
			'video_mute',
			array(
				'label'        => esc_html__( 'Mute', 'omniverse' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'no',
				'condition'    => array(
		...
		$this->add_control(
			'video_loop',
			array(
				'label'        => esc_html__( 'Loop', 'omniverse' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'no',
				'condition'    => array(
		...
		$this->add_control(
			'video_controls',
			array(
				'label'        => esc_html__( 'Controls', 'omniverse' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
				'condition'    => array(
		...
		$this->add_control(
			'video_preload',
			array(
				'label'       => esc_html__( 'Preload', 'omniverse' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'metadata' => esc_html__( 'Metadata', 'omniverse' ),
		...
		$this->add_control(
			'video_poster',
			array(
				'label'     => esc_html__( 'Poster', 'omniverse' ),
				'type'      => Controls_Manager::MEDIA,
				'condition' => array(
					'video_type'          => 'hosted',
					'video_action_button' => 'without',
		...
		$this->start_controls_section(
			...
			array(
				'label'     => esc_html__( 'Image overlay', 'omniverse' ),
				'condition' => array(
					'video_action_button' => 'overlay',
				),
			)
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'aspect_ratio' => esc_html__( 'Aspect ratio', 'omniverse' ),
		...
		$this->add_control(
			'video_aspect_ratio',
			array(
				'label'     => esc_html__( 'Aspect Ratio', 'omniverse' ),
				'type'      => Controls_Manager::SELECT,
				'selectors' => array(
		...
		omniverse_get_button_style_general_map( $this );
		...
		omniverse_get_button_style_layout_map( $this );
		...
		omniverse_get_button_style_icon_map( $this );
		...
		$this->start_controls_section(
			...
			array(
				'label'     => esc_html__( 'Play button', 'omniverse' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Label typography', 'omniverse' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => esc_html__( 'Icon size', 'omniverse' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min' => 40,
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Icon color', 'omniverse' ),
				'type'      => Controls_Manager::HEADING,
			)
		);
	...
	protected function render() {
		...
		omniverse_enqueue_js_script( 'video-element' );
		omniverse_enqueue_inline_style( 'el-video' );
		...
		if ( 'overlay' === $element_args['video_action_button'] && $element_args['video_image_overlay']['id'] ) {
			$image_output = omniverse_otf_get_image_html( $element_args['video_image_overlay']['id'], $element_args['video_image_overlay_size'], $element_args['video_image_overlay_custom_dimension'] );
		}
		...
		if ( 'play' === $element_args['video_action_button'] || 'button' === $element_args['video_action_button'] || 'yes' === $element_args['video_overlay_lightbox'] ) {
			...
			omniverse_enqueue_js_script( 'video-element-popup' );
		}
		?>
		...
		<div class="wd-el-video<?php echo esc_attr( $wrapper_classes ); ?>">
			...
			<?php if ( 'button' === $element_args['video_action_button'] && $element_args['button_text'] ) : ?>
				...
				<?php omniverse_elementor_button_template( $element_args ); ?>
			<?php endif; ?>
