...
if ( ! class_exists( 'OMNIVERSE_Stock_Status' ) ) {
	class OMNIVERSE_Stock_Status extends WPH_Widget {
		function __construct() {
			...
			$args = array(
				'label'       => esc_html__( 'OMNIVERSE Stock status', 'omniverse' ),
				'description' => esc_html__( 'Filter stock and on-sale products', 'omniverse' ),
			...
			$args['fields'] = array(
				array(
					'id'      => 'title',
					'type'    => 'text',
					'default' => esc_html__( 'Stock status', 'omniverse' ),
				...
				array(
					...
					'type'    => 'checkbox',
					'default' => 1,
					'name'    => esc_html__( 'In Stock filter', 'omniverse' ),
				),
				...
				array(
					...
					'type'    => 'checkbox',
					'default' => 1,
					'name'    => esc_html__( 'On Sale filter', 'omniverse' ),
				),
				...
				array(
					...
					'type'    => 'checkbox',
					'default' => 0,
					'name'    => esc_html__( 'On backorder filter', 'omniverse' ),
				),
			);
		...
		function get_link( $status ) {
			$base_link            = omniverse_shop_page_link( true );
