...
if( ! class_exists( 'OMNIVERSE_Widget_Search' ) ) {
	class OMNIVERSE_Widget_Search extends WPH_Widget {
		...
		function __construct() {
			...
			$args = array( 
				...
				'label' => esc_html__( 'OMNIVERSE AJAX Search', 'omniverse' ),
				// Widget Backend Description								
				'description' =>esc_html__( 'Search form by products with AJAX', 'omniverse' ),
				'slug' => 'omniverse-ajax-search',
			 );
			...
			$args['fields'] = array(
				array(
					'id'	=> 'title',
					'type'  => 'text',
					'std'   => esc_html__( 'Search products', 'omniverse' ),
				...
				array(
					...
					'type' => 'dropdown',
					'std'  => 'product',
					'name' => esc_html__( 'Search post type', 'omniverse' ),
					'fields' => array(
				...
				array(
					...
					'type'  => 'number',
					'std'   => 4,
					'name' 	=> esc_html__( 'Number of products to show', 'omniverse' ),
				),
				array(
					'id'	=> 'price',
					'type'  => 'checkbox',
					'std'   => 1,
					'name' 	=> esc_html__( 'Show price', 'omniverse' ),
				),
				array(
					'id'	=> 'thumbnail',
					'type'  => 'checkbox',
					'std'   => 1,
					'name' 	=> esc_html__( 'Show thumbnail', 'omniverse' ),
				),
				array(
					'id'	=> 'categories',
					'type'  => 'checkbox',
					'std'   => 1,
					'name' 	=> esc_html__( 'Show categories', 'omniverse' ),
				),
			);
