	...
	<div class="wd-cat-inner">
		...
		<div class="wd-cat-content wd-fill">
			...
			<div class="wd-cat-header">
				<h3 class="wd-entities-title<?php echo esc_attr( omniverse_get_old_classes( ' category-title' ) ); ?>">
				...
				<?php if ( ! $args['hide_product_count'] ) : ?>
					<div class="wd-cat-count">
						<?php echo sprintf( _n( '%s product', '%s products', $args['category']->count, 'omniverse' ), $args['category']->count ); ?>
					</div>
				<?php endif; ?>
			</div>
		</div>
