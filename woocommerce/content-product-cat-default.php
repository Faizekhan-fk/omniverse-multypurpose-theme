	...
	<div class="wrapp-category">
		<div class="category-image-wrapp">
			<a href="<?php echo esc_url( get_term_link( $args['category']->slug, 'product_cat' ) ); ?>" class="category-image">
				 ...
				 *
				 * @hooked omniverse_category_thumb_double_size - 10
				 */
		...
		<div class="hover-mask">
			<h3 class="wd-entities-title<?php echo omniverse_get_old_classes( ' category-title' ); ?>">
				<?php
			...
			<?php if ( ! $args['hide_product_count'] ) : ?>
				<div class="more-products"><a href="<?php echo esc_url( get_term_link( $args['category']->slug, 'product_cat' ) ); ?>"><?php echo sprintf( _n( '%s product', '%s products', $args['category']->count, 'omniverse' ), $args['category']->count ); ?></a></div>
			<?php endif; ?>
		...
		<a href="<?php echo esc_url( get_term_link( $args['category']->slug, 'product_cat' ) ); ?>" class="category-link wd-fill" aria-label="<?php echo esc_attr( sprintf( __( 'Product category %s', 'omniverse' ), $args['category']->slug ) ); ?>"></a>
