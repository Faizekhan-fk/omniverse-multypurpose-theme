...
$tabs = omniverse_get_opt( 'login_tabs' );
$reg_text = omniverse_get_opt( 'reg_text' );
$login_text = omniverse_get_opt( 'login_text' );
$account_link = get_permalink( get_option( 'woocommerce_myaccount_page_id' ) );

$class = 'wd-registration-page';
$class .= omniverse_get_old_classes( ' omniverse-registration-page' );

if ( $tabs && get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) {
	omniverse_enqueue_js_script( 'login-tabs' );
	$class .= ' wd-register-tabs';
	$class .= omniverse_get_old_classes( ' omniverse-register-tabs' );
}
...
omniverse_enqueue_inline_style( 'woo-page-login-register' );
...
<?php endif; ?>
		...
		<?php omniverse_login_form( true, add_query_arg( 'action', 'login', $account_link ) ); ?>
	...
	<?php if ( $tabs ): ?>
		<div class="col-12 col-md-6 col-register-text">
			...
			<?php 
				...
				$login_title = omniverse_get_opt( 'login_title' ) ? omniverse_get_opt( 'login_title' ) : esc_html__( 'Login', 'woocommerce' );
