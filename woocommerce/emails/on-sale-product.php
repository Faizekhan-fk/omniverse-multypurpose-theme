...
<p>
	<?php esc_html_e( 'Products on your wishlist are on sale!', 'omniverse' ); ?>
</p>
...
<?php if ( $product_lists ) : ?>
	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin: 0 0 16px;" border="1">
		<thead>
		<tr>
			<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Products', 'omniverse' ); ?></th>
