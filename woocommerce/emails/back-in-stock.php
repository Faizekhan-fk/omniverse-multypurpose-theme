...
<p>
	<?php esc_html_e( sprintf( 'Hi, %s!', $email->user->user_login ), 'omniverse' ); ?>
</p>

<p>
	<?php esc_html_e( 'The product on your wishlist is back in stock!', 'omniverse' ); ?>
</p>
...
<?php if ( $product_lists ) : ?>
	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin: 0 0 16px;" border="1">
		<thead>
		<tr>
			<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Product', 'omniverse' ); ?></th>
			<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Price', 'omniverse' ); ?></th>
...
<p>
	<?php esc_html_e( 'We only have limited stock, so don\'t wait any longer, and take this chance to make it yours!', 'omniverse' ); ?>
</p>
