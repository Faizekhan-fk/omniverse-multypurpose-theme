...
if ( Global_Data::get_instance()->get_data( 'shop_pagination' ) ) {
	...
	$pagination = omniverse_loop_prop( 'shop_pagination' );
}
	...
	<div class="wd-loop-footer products-footer">
		<?php if ( $pagination == 'more-btn' || $pagination == 'infinit' ) : ?>
			<?php if ( get_next_posts_link() ) : ?>
				...
				<a href="<?php echo next_posts( $wp_query->max_num_pages, false ); ?>" rel="nofollow noopener" class="btn wd-load-more wd-products-load-more load-on-<?php echo 'more-btn' === $pagination ? 'click' : 'scroll'; ?>"><span class="load-more-label"><?php esc_html_e( 'Load more products', 'omniverse' ); ?></span></a>
