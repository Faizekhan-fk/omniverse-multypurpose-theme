...
<table class="woocommerce-product-attributes shop_attributes">
	<?php foreach ( $product_attributes as $product_attribute_key => $product_attribute ) : ?>
		...
		$thumb_id       = get_option( 'omniverse_pa_' . $attribute_name . '_thumbnail' );
		$image_size     = apply_filters( 'omniverse_product_attributes_table_image_size', 'thumbnail' );
		$attribute_hint = get_option( 'omniverse_pa_' . $attribute_name . '_hint' );
		...
		<tr class="woocommerce-product-attributes-item woocommerce-product-attributes-item--<?php echo esc_attr( $product_attribute_key ); ?>">
			<th class="woocommerce-product-attributes-item__label">
				<?php if ( ! empty( $thumb_id ) ) : ?>
					<?php if ( omniverse_is_svg( wp_get_attachment_image_url( $thumb_id ) ) ) : ?>
						<?php echo omniverse_get_svg_html( $thumb_id, $image_size, array( 'class' => 'wd-attr-img' ) ); //phpcs:ignore. ?>
					<?php else : ?>
