...
$accordion_state = omniverse_get_opt( 'product_accordion_state', 'first' );
$content_count   = 0;
$tab_count       = 0;
...
if ( 'accordion' === $tabs_layout ) {
	...
	omniverse_enqueue_inline_style( 'woo-single-prod-el-tabs-opt-layout-tabs' );
}

omniverse_enqueue_js_script( 'single-product-tabs-accordion' );
...
<div class="woocommerce-tabs wc-tabs-wrapper<?php echo esc_attr( $wrapper_classes ); ?>" data-state="<?php echo esc_attr( $accordion_state ); ?>" data-layout="<?php echo esc_attr( $tabs_layout ); ?>">
		...
		<?php foreach ( $product_tabs as $key => $product_tab ) : ?>
			<?php
			$item_wrapper_classes             = omniverse_get_old_classes( ' omniverse-tab-wrapper' );
			$accordion_title_wrapper_classes  = omniverse_get_old_classes( ' omniverse-accordion-title' );
			...
			if ( 'accordion' === $tabs_layout ) {
				...
				$item_wrapper_classes = omniverse_get_old_classes( ' wd-tab-wrapper omniverse-tab-wrapper' );
			}
