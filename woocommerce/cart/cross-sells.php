...
if ( $cross_sells ) : ?>
	...
	<div class="cross-sells">
		...
		<?php
			omniverse_enqueue_product_loop_styles( omniverse_get_opt( 'products_hover' ) );

			$slider_args = array(
				'slides_per_view'              => apply_filters( 'omniverse_cross_sells_products_per_view', 4 ),
				'hide_pagination_control'      => true,
				'hide_prev_next_buttons'       => true,
				'img_size'                     => 'woocommerce_thumbnail',
				'custom_sizes'                 => apply_filters( 'omniverse_cross_sells_custom_sizes', false ),
			...
			omniverse_set_loop_prop( 'products_view', 'carousel' );

			echo omniverse_generate_posts_slider( $slider_args, false, $cross_sells );
