...
$items_to_show = apply_filters( 'omniverse_mini_cart_items_to_show', 30 );
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>" data-key="<?php echo esc_attr( $cart_item_key ); ?>">
								...
								<div class="cart-info">
									...
									<?php if ( omniverse_get_opt( 'show_sku_in_mini_cart' ) ) : ?>
										<div class="wd-product-sku">
											<span class="wd-label">
												<?php esc_html_e( 'SKU:', 'omniverse' ); ?>
											</span>
											<span>
									...
									<?php
									if ( ! $_product->is_sold_individually() && $_product->is_purchasable() && omniverse_get_opt( 'mini_cart_quantity' ) && apply_filters( 'omniverse_show_widget_cart_item_quantity', true, $cart_item_key ) ) {
