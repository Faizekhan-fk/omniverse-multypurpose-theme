...
global $omniverse_portfolio_loop, $post;

$size  = omniverse_loop_prop( 'portfolio_image_size' );
$img   = omniverse_otf_get_image_html( get_post_thumbnail_id(), omniverse_loop_prop( 'portfolio_image_size' ), omniverse_loop_prop( 'portfolio_image_size_custom' ) );
$style = omniverse_loop_prop( 'portfolio_style' );
			...
			<figure class="entry-thumbnail color-scheme-light">
				...
				<div class="wd-portfolio-btns">
					<div class="portfolio-enlarge wd-action-btn wd-style-icon wd-enlarge-icon wd-tltp wd-tltp-left">
						<a href="<?php echo esc_url( wp_get_attachment_url( get_post_thumbnail_id( $post->ID ) ) ); ?>" data-elementor-open-lightbox="no"><?php esc_html_e( 'View Large', 'omniverse' ); ?></a>
					</div>
