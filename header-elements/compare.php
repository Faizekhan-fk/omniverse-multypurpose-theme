...
if ( ! $params['hide_product_count'] ) {
	...
	$extra_class .= omniverse_get_old_classes( ' with-product-count' );
}
...
$extra_class .= omniverse_get_old_classes( ' omniverse-compare-info-widget' );

omniverse_enqueue_js_script( 'omniverse-compare' );
?>

<div class="wd-header-compare wd-tools-element<?php echo esc_attr( $extra_class ); ?>">
	<a href="<?php echo esc_url( omniverse_get_compare_page_url() ); ?>" title="<?php echo esc_attr__( 'Compare products', 'omniverse' ); ?>">
		...
		<?php endif; ?>
			...
			<span class="wd-tools-icon<?php echo omniverse_get_old_classes( ' compare-icon' ); ?>">
				<?php
				if ( $icon_type == 'custom' ) {
				...
				<?php if ( ! $params['hide_product_count'] ) : ?>
					<span class="wd-tools-count<?php echo omniverse_get_old_classes( ' compare-count' ); ?>"><?php echo omniverse_get_compare_count(); ?></span>
				<?php endif; ?>
			</span>
			<span class="wd-tools-text<?php echo omniverse_get_old_classes( ' compare-label' ); ?>">
	...
	<?php if ( omniverse_get_opt( 'compare_by_category' ) && ! empty( $params['show_dropdown_category'] ) ) : ?>
