...
$extra_class .= omniverse_get_old_classes( ' omniverse-wishlist-info-widget' );

omniverse_enqueue_js_script( 'wishlist' );
?>

<div class="wd-header-wishlist wd-tools-element<?php echo esc_attr( $extra_class ); ?>" title="<?php echo esc_attr__( 'My Wishlist', 'omniverse' ); ?>">
	<a href="<?php echo esc_url( omniverse_get_wishlist_page_url() ); ?>">
		...
		<?php endif; ?>
			...
			<span class="wd-tools-icon<?php echo omniverse_get_old_classes( ' wishlist-icon' ); ?>">
				<?php
				if ( $icon_type == 'custom' ) {
			...
			<span class="wd-tools-text<?php echo omniverse_get_old_classes( ' wishlist-label' ); ?>">
				<?php esc_html_e( 'Wishlist', 'omniverse' ); ?>
			</span>
