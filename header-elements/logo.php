<?php
$logo_url = OMNIVERSE_IMAGES . '/omni-logo-dark.svg';

$protocol = omniverse_http() . '://';
...
<div class="site-logo<?php echo esc_attr( $logo_classes ); ?>">
	<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="wd-logo wd-main-logo<?php echo omniverse_get_old_classes( ' omniverse-logo omniverse-main-logo' ); ?>" rel="home">
